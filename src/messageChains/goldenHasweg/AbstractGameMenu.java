package messageChains.goldenHasweg;
        ...
        switch (keyCode) {
            case KeyEvent.VK_ESCAPE:
                ...
                if (controller.getCurrentMenu().getParentMenue() == null) {
                    ...
                    if (!controller.getModel().isPause()) {
            ...
            case KeyEvent.VK_ENTER:
                ...
                if (model.getSelectionMode().isSelectionEnabled()) {
                    if (model.getSelectionMode().isMultiSelectionEnabled()) {
                        if (model.isFirstSelectionDone()) {
                            controller.closeSubmenu();
                        } else {
                            model.firstSelectionDone();
                        }
                    } else {
                        controller.closeSubmenu();
                    }
